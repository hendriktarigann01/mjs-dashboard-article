    ...
    <MainLayout showNavbar={true} showSearch={true}>
      <div className="space-y-6 min-h-screen">
        ...
        {/* <div className="space-y-4">
          <Alert type="success" message="Your account has been saved." />
          <Alert type="error" message="Your email address is invalid." />
          <Alert type="warning" message="You are currently on the Free plan." />
          <Alert type="info" message="We've updated a few things." />
        </div> */}
